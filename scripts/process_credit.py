"""
Dataset: Japanese Credit Screening Data Set,
Url: http://archive.ics.uci.edu/ml/datasets/Japanese+Credit+Screening
Download:
```bash
    mkdir -p ../datasets/credit
    curl http://archive.ics.uci.edu/ml/machine-learning-databases/credit-screening/crx.data \
        -o ../datasets/credit/crx.data
```
"""
import numpy as np
import pandas as pd

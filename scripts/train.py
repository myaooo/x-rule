...
if __name__ == '__main__':
    ...
    # train_rule(dataset='abalone', min_support=0.005, eta=2)
    ...
    # train_nn(dataset='abalone', neurons=(40, 40, 40), tol=1e-6, alpha=0.01, verbose=True)
    ...
    # train_surrogate('models/adult-nn-30-30.mdl', surrogate='rule', sampling_rate=2)

...
export type DimType = number[] | Int8Array | Int16Array | Int32Array | Uint8Array | Uint16Array | Uint32Array;
...
export interface NdArray<T = number> extends BaseNdArray<T> {
	...
	*
	*/
	pick(...args: (number | null)[]): NdArray<T>;
	 ...
	 */
	equal<U>(array: NdArrayLike<U>): boolean;
	 ...
	 */
	convolve(filter: NdArrayLike<T>): NdArray<T>;

	fftconvolve(filter: NdArrayLike<T>): NdArray<T>;
}

export type NdArrayData<T> = BaseNdArray.Data<T>;
export type NdArrayLike<T> = NdArrayData<T> | NdArray<T>;
export type NjParam<T> = NdArrayLike<T> | number;
 ...
 *
 */
export function concatenate<T = number>(...arrays: Array<NdArrayLike<T>>): NdArray<T>;

/**
 * Convolve 2 N-dimensionnal arrays
 *
 */
export function convolve<T = number>(a: NdArrayLike<T>, b: NdArrayLike<T>): NdArray<T>;
 ...
 *
 */
export function divide<T = number>(a: NdArrayLike<T>, b: NjParam<T>): NdArray<T>;
 ...
 *
 */
export function dot<T = number>(a: NdArrayLike<T>, b: NdArrayLike<T>): NdArray<T>;
 ...
 */
export function empty<T = number>(shape: DimType | number, dtype?: NdType<T>): NdArray<T>;

/**
 * Return true if two arrays have the same shape and elements, false otherwise.
 *
 */
export function equal<T = number>(a: NdArrayLike<T>, b: NdArrayLike<T>): boolean;
 ...
 *
 */
export function fftconvolve<T = number>(a: NdArrayLike<T>, b: NdArrayLike<T>): NdArray<T>;

/**
 * Return a copy of the array collapsed into one dimension using row-major order (C-style)
 *
 */
export function flatten<T = number>(array: NdArrayLike<T>): NdArray<T>;
 ...
 *
 */
export function multiply<T = number>(a: NdArrayLike<T>, b: NjParam<T>): NdArray<T>;
 ...
 */
export function reshape<T = number>(array: NdArrayLike<T>, shape: NdArrayLike<number>): NdArray<T>;

/**
 * Round an array to the to the nearest integer.
 *
 */
export function round<T = number>(x: NdArrayLike<T>): NdArray<T>;
 ...
 */
export function zeros<T = number>(shape: DimType | number, dtype?: BaseNdArray.DataType): NdArray<T>;
...
export function fft<T = number>(x: NdArrayLike<T>): NdArray<T>;

export function ifft<T = number>(x: NdArrayLike<T>): NdArray<T>;
 ...
 */
export function diag<T = number>(x: NdArrayLike<T>): NdArray<T>;
...
export function array<T = number, RT = T>(arr: NdArrayLike<T>, dtype?: BaseNdArray.DataType): NdArray<RT>;

export function array<T = number>(arr: NdArray<T>, dtype?: BaseNdArray.DataType): NdArray<T>;

export function int8<T = number>(arr: NdArrayLike<T>): NdArrayLike<Int8Array>;

export function uint8<T = number>(arr: NdArrayLike<T>): NdArrayLike<Uint8Array>;

export function int16<T = number>(arr: NdArrayLike<T>): NdArrayLike<Int16Array>;

export function uint16<T = number>(arr: NdArrayLike<T>): NdArrayLike<Uint16Array>;

export function int32<T = number>(arr: NdArrayLike<T>): NdArrayLike<Int32Array>;

export function uint32<T = number>(arr: NdArrayLike<T>): NdArrayLike<Uint32Array>;

export function float32<T = number>(arr: NdArrayLike<T>): NdArrayLike<Float32Array>;

export function float64<T = number>(arr: NdArrayLike<T>): NdArrayLike<Float64Array>;
